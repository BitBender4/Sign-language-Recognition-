...
Preprocessing with aspect ratio padding (white background)

Gesture classification using a custom .h5 deep learning model

Centered display of predicted letter only (clean UI)

Works offline and runs on most machines with Python
